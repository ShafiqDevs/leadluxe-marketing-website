...
const FloatingImageWithText = ({
	...
	// 	<Image
	// 		className='col-span-6 md:col-span-3 w-auto aspect-auto mx-auto lg:mx-0 lg:ml-auto md:order-last'
	// 		alt='your business problems solved by sigma marketing .co.uk'
	// 		src={'/ads images/man with laptop and coffee.png'}
	// 		width={427}
	// 		height={392}
	// 	/>
	// 	<div className='col-span-6 md:col-span-3 flex flex-col w-full gap-4 text-text text-start '>
