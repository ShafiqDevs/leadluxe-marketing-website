...
export default function Page() {
	return (
		<main className=' min-h-screen'>
			<Section id='section-terns-and-conditions'>
				<div className='flex flex-col gap-2'>
					<h2 className='text-lg font-medium'>
						<strong>Terms and Conditions</strong>
					</h2>

					<p>Welcome to Sigma marketing!</p>

					<p>
						These terms and conditions outline the rules and
						regulations for the use of Sigma marketing's Website,
						located at https://www.sigmamarketing.co.uk/.
					</p>

					<p>
						By accessing this website we assume you accept these terms
						and conditions. Do not continue to use Sigma marketing if
					...
					<p>
						...
						prevailing law of gb. Any use of the above terminology or
					...
					<p>
						We employ the use of cookies. By accessing Sigma
						marketing, you agreed to use cookies in agreement with the
						Sigma marketing's Privacy Policy.{' '}
					</p>
					...
					<p>
						Unless otherwise stated, Sigma marketing and/or its
						licensors own the intellectual property rights for all
						material on Sigma marketing. All intellectual property
						rights are reserved. You may access this from Sigma
						marketing for your own personal use subjected to
						restrictions set in these terms and conditions.
					</p>

					<p>You must not:</p>
					<ul>
						<li>Republish material from Sigma marketing</li>
						<li>
							Sell, rent or sub-license material from Sigma marketing
						</li>
						<li>
							Reproduce, duplicate or copy material from Sigma
							marketing
						</li>
						<li>Redistribute content from Sigma marketing</li>
					</ul>
					...
					<p>
						...
						areas of the website. Sigma marketing does not filter,
						edit, publish or review Comments prior to their presence
						on the website. Comments do not reflect the views and
						opinions of Sigma marketing,its agents and/or affiliates.
						Comments reflect the views and opinions of the person who
						post their views and opinions. To the extent permitted by
						applicable laws, Sigma marketing shall not be liable for
					...
					<p>
						Sigma marketing reserves the right to monitor all Comments
					...
					<p>
						You hereby grant Sigma marketing a non-exclusive license
					...
					<p>
						...
						hyperlink compensates the absence of Sigma marketing; and
					...
					<p>
						...
						must inform us by sending an e-mail to Sigma marketing.
					...
					<p>
						No use of Sigma marketing's logo or other artwork will be
